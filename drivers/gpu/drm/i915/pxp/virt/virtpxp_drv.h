...
#else
static void put_virtio_pxp(struct virtio_pxp *vpxp)
{
}
static int virtio_set_session(struct virtio_pxp *vpxp, struct prelim_drm_i915_pxp_set_session_status_params *params)
{
	return -1;
}
static int virtio_io_msg(struct virtio_pxp *vpxp, struct prelim_drm_i915_pxp_tee_io_message_params *params)
{
	return -1;
}
static int virtio_query_tag(struct virtio_pxp *vpxp, struct prelim_drm_i915_pxp_query_tag *params)
{
	return -1;
}
static int virtio_host_session_handle_request(struct virtio_pxp *vpxp, struct prelim_drm_i915_pxp_host_session_handle_request *params)
{
	return -1;
}
static int virtpxp_register_intel_gpu_device(int device_idx, int device_vfid, void *gpu_priv,
			int (*bind)(void *gpu_priv, void *pxp_priv), void (*unbind)(void *gpu_priv))
{
	return -1;
}
static void virtpxp_unregister_intel_gpu_device(int device_idx, int device_vfid, void *gpu_priv)
{
}
static int virtio_pxp_init(void)
{
	return -1;
}
static void virtio_pxp_exit(void)
{
}
